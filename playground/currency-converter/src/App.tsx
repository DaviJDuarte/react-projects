...
function App() {
    ...
    return (
        <main>
            <CurrencyForm currencies={currencies} onChangeQuantity={changeQuantityHandler}
                          onChangeFromCurrency={changeFromCurrencyHandler}
                          onChangeToCurrency={changeToCurrencyHandler}
                          fromCurrency={fromCurrency}/>

            <DisplayConvertedCurrency quantity={quantity} fromCurrency={fromCurrency} toCurrency={toCurrency}/>
        </main>
    );
}
